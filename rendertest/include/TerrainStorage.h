...
private:
    ...
    static auto GetChunkCoordinatesInSquare(PlaneCoord coord, int radius) -> std::vector<ChunkCoord>;
...
public:
    static auto GetChunkCoordinatesInRadius(PlaneCoord coord, int radius) -> std::vector<ChunkCoord>;

    auto GenerateChunk          (ChunkCoord coord) -> void;
    auto GenerateChunksInRadius (PlaneCoord coord, int radius) -> void;
